...
<main id="taxonomy-genre" class="l-container">
      ...
      <div class="p-sub-works__inner">
         <nav class="p-sub-works__menu p-navigation-archive">
            <ul class="p-navigation-archive__items">
               <li class="p-navigation-archive__item"><a href="<?php echo $works_link; ?>">ALL</a></li>
               ...
               <?php foreach ( $genre_terms as $genre_term ) : ?>
                  <li class="p-navigation-archive__item"><a href="<?php echo esc_url( get_term_link( $genre_term, 'genre' ) ); ?>" class="<?php if( $cat_name == esc_html($genre_term->name)){ echo "is-active";}; ?>"><?php echo esc_html( $genre_term->name ); ?></a></li>
               <?php endforeach; ?>
