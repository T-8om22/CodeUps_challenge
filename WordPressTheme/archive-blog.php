...
<main id="sub-blog" class="l-container">
      ...
      <div class="p-sub-blog__inner">
         <nav class="p-sub-blog__menu p-navigation-archive">
            <ul class="p-navigation-archive__items">
               <li class="p-navigation-archive__item"><a href="<?php echo $blog_link; ?>" class="is-active">ALL</a></li>

               <?php $topics_terms = get_terms( 'topics', array( 'hide_empty' => false ) ); ?>
               <?php foreach ( $topics_terms as $topics_term ) : ?>
                  <li class="p-navigation-archive__item"><a href="<?php echo esc_url( get_term_link( $topics_term, 'topics' ) ); ?>"><?php echo esc_html( $topics_term->name ); ?></a></li>
               <?php endforeach; ?>
